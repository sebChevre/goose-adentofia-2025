  ...
  if (isMobile) {
    ...
    <div className='grid gap-1 px-1'>
      ...
      {flight.position && (
        ...
        >
          <h3 id="position-heading" className="text-sm font-semibold text-foreground mb-3 flex items-center gap-2">
      ...
      >
        <h3 id="technical-heading" className="text-sm font-semibold text-foreground mb-3">
          Technical Info
        </h3>
        <div className="space-y-2">
          <div className="flex justify-between items-center">
            <span className="text-sm text-muted-foreground">ICAO24 ID</span>
            <span className="text-sm font-mono text-foreground">{flight.id}</span>
          </div>
          <div className="flex justify-between items-center">
            <span className="text-sm text-muted-foreground">Callsign</span>
            <span className="text-sm font-mono text-foreground">{flight.callsign}</span>
          </div>
        </div>
      </section>
    </div>
    ...
    <>
      ...
      <section
        ...
        aria-labelledby="status-heading"
      >
        <h3 id="status-heading" className="text-sm font-semibold text-foreground mb-3">
          Status
        </h3>
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      ...
      >
        <DialogHeader>
          ...
          <DialogDescription id="flight-details-description" className="text-muted-foreground">
            Flight Details • {flight.country}
          </DialogDescription>
        </DialogHeader>
        {modalContent}
