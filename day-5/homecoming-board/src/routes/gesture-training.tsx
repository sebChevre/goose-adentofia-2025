...
export const Route = createFileRoute("/gesture-training")({
	component: GestureTraining,
});
...
function GestureTraining() {
	...
	const handleThresholdsLearned = useCallback((thresholds: any) => {
		...
		alert(
			"✅ Training complete! Your custom gesture thresholds are now active.\n\nGo to the Flight Board to test them!",
		);
	}, []);
		...
		<div className="min-screen bg-gradient-to-b from-background via-primary/10 to-background">
			...
			<header className="pt-4 px-6 text-center">
				<div className="max-w-7xl mx-auto">
					<h1 className="sr-only">Gesture Training Mode</h1>
					<p>Perfect your gestures before using them on the flight board!</p>
				</div>
			</header>
					...
					<div>
						...
						<div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
							<div className="rounded-lg p-4">
								...
								<p className="">
									<strong>Top-left</strong>: Live finger curl values
									(0.0=extended, 1.0=curled)
									<br />
									<strong>Top-right</strong>: Detected gesture & training
									controls
								</p>
							</div>
							<div className="rounded-lg p-4">
								...
								<p className="">
									Click "Start Training Mode" in the top-right overlay. You'll
									see correction buttons appear.
								</p>
							</div>
							<div className="rounded-lg p-4">
								<div className="text-3xl mb-2">✋</div>
								...
								<p className="">
									Make a gesture. If it's wrong or unknown, click the correct
									button (Fist/Palm/Thumbs Up/Down). Do this 3 times per
									gesture.
								</p>
							</div>
							<div className="rounded-lg p-4">
								...
								<p className="">
									After collecting 9+ samples (3 per gesture × 3 gestures),
									click "Finish Training & Apply" to use your custom thresholds!
								</p>
							</div>
						</div>
					</div>
